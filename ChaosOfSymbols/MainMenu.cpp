...
void MainMenu::RenderAboutScreen() {
    ...
    rlutil::locate(2, 7);
    std::cout << "You are free to use and modify this asset with attributione";
    rlutil::locate(2, 9);
    std::cout << "Menu controls:";
    rlutil::locate(2, 10);
    std::cout << "[W] [S] or Up and Down arrows - Move between menu oprions";
    rlutil::locate(2, 11);
    std::cout << "[A] [D] or Left and Right arrows - Decrease and increase selected values";
    rlutil::locate(2, 12);
    std::cout << "[Space] or [Enter] - Confirm";
    rlutil::locate(2, 13);
    std::cout << "[Tab] or [Shift]  + [Tab] - Move between World Editor tabs";
    rlutil::locate(2, 14);
    std::cout << "[Ctrl] + [C] and [Ctrl] + [V] - use to add cellular automaton rules";
    rlutil::locate(2, 16);
    std::cout << "Game controls:";
    rlutil::locate(2, 17);
    std::cout << "[W] [A ] [S] [D], Arrow keys - Move";
    rlutil::locate(2, 18);
    std::cout << "[Esc] - Back";
